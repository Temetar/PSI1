...
output_path = "/home/l_tester/work/pixel_phase2/Ph2_ACF_runs/tamar2/PythonScript/1D/" #Path where the output files are saved. Should end in '/'.
start = {0} #0: Autogenerate 1: voltagetuning 2: latency 3: threshold equalization 4: threshold adjustment 5:scurve
####################
